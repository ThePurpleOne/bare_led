...
const MUART_AUXEN: u32 = 0x3F21_5004; // ENABLE (p.9)

// Auxiliary registers (p.8)
const MUART_IO: u32 = 0x3F21_5040; // Mini Uart I/O Data
const MUART_IER: u32 = 0x3F21_5044; // Mini Uart Interrupt Enable
const _MUART_IIR: u32 = 0x3F21_5048; // Mini Uart Interrupt Identify
const MUART_LCR: u32 = 0x3F21_504C; // Mini Uart Line Control
const MUART_MCR: u32 = 0x3F21_5050; // Mini Uart Modem Control
const MUART_LSR: u32 = 0x3F21_5054; // Mini Uart Line Status
const _MUART_MSR: u32 = 0x3F21_5058; // Mini Uart Modem Status
                                     // const _MUART_SCRATCH: u32 = 0x3F21_505C; // Mini Uart Scratch
const MUART_CNTL: u32 = 0x3F21_5060; // Mini Uart Extra Control
const _MUART_STAT: u32 = 0x3F21_5064; // Mini Uart Extra Status
const MUART_BAUD: u32 = 0x3F21_5068; // Mini Uart Baudrate
